                ...
                <div className="max-w-7xl mx-auto grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight">
                            সমস্যা নয়,  
                            <br />
                           সঠিক সমাধানই আপনার <span className="text-[#FF6B35]">ব্যবসাকে এগিয়ে নিয়ে যায়</span>!
                        </h2>
                    ...
                    <div className="rounded-[2rem] overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl">
                        <div className="p-4 sm:p-5 bg-slate-100 dark:bg-slate-950/80 border-b border-slate-200 dark:border-slate-800">
                            <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">ভিডিও পরিচিতি</p>
                        </div>
                        <video
