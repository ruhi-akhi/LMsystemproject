...
const Footer = () => {
  return (
    <footer
      ...
      className="w-full bg-[#F9F5FF] dark:bg-[#0b1120] pt-16 pb-6 transition-colors duration-300 border-t border-gray-100 dark:border-gray-800"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#1e293b] p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
              <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase mb-2">Support Hotline</p>
              <div className="flex items-center gap-3">
            ...
            <ul className="space-y-4 text-sm font-medium">
              {footerLinks.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.path}
                    className="text-gray-600 dark:text-gray-400 hover:text-[#FF6B35] dark:hover:text-[#FF8C42] transition-colors"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="https://www.facebook.com/" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
              ...
              <a href="https://www.instagram.com/" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
              ...
              <a href="https://www.youtube.com/" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
              ...
              <a href="https://www.linkedin.com/" className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 group">
          ...
          <div>
            <h4 className="font-bold text-gray-900 dark:text-white mb-6 text-lg">Download App</h4>
            <div className="space-y-4">
              <button type="button" className="flex items-center gap-3 w-full max-w-[200px] bg-[#1a1a1a] dark:bg-black text-white p-3 rounded-xl hover:opacity-80 transition-all border border-gray-800">
                <FaApple size={28} />
              ...
              <button type="button" className="flex items-center gap-3 w-full max-w-[200px] bg-[#1a1a1a] dark:bg-black text-white p-3 rounded-xl hover:opacity-80 transition-all border border-gray-800">
                ...
                <div className="text-left">
                  ...
                  <a href="https://apps.microsoft.com/" target="_blank" rel="noopener noreferrer">
